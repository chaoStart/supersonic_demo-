package com.tencent.supersonic.demo.mapper.timextractor;

import com.tencent.supersonic.demo.mapper.timextractor.nlp.TimeNormalizer;
import com.tencent.supersonic.demo.mapper.timextractor.nlp.TimeUnit;
import com.tencent.supersonic.demo.mapper.timextractor.util.DateUtil;
...
public class TimeAnalyseTest {
    public static void testTimeNLP() throws URISyntaxException {
...
//		normalizer.parse("下月出差");// 多时间识别
//		TimeUnit[] unit = normalizer.getTimeUnit();
//		System.out.println("下月出差");
//		System.out.println(DateUtil.formatDateDefault(unit[0].getTime()) + "-" + unit[0].getIsAllDayTime());
